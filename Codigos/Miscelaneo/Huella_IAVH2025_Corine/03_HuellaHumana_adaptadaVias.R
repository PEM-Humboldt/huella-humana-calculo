...
writeRaster(
  IHEH1002,
  paste0(dir_Resultados, "/IHEH_IAVH1Cor", Año, ".tif"), 
  overwrite=TRUE)
...
writeRaster(
  r_class,
  paste0(dir_Resultados, "/IHEH_IAVH_classCor", Año, ".tif"), 
  overwrite=TRUE)

Sys.time()


## Guardar resultado crs:wgs####
Año <- 2022
...
writeRaster(
  IHEH1002_wgs,
  paste0(dir_Resultados, "/IHEH_IAVHCor_wgs", Año, ".tif"), 
  overwrite=TRUE)
writeRaster(
  r_class_wgs,
  paste0(dir_Resultados, "/IHEH_IAVHCor_class_wgs", Año, ".tif"), 
  overwrite=TRUE)
