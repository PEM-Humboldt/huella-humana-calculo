...
# Ruta a la GDB
gdb_path <- file.path(
  dir_datos,  "Corine/Cobertura_de_la_Tierra_100K_Periodo_2018/COBERTURAS CORINE 2018/ECOSISTEMAS_062021.gdb"
)
...
corine <- st_read(gdb_path, layer = "cobertura_tierra_clc_2018")
...
archivo_LU0 <- file.path(dir_Intermedios,paste0( "LU0_corine",Año,".tif"))
archivo_TNT0 <- file.path(dir_Intermedios,paste0( "TNT0_corine",Año,".tif"))
