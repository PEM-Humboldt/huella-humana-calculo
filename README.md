...
🔹 Scripts principales (nivel raíz de Codigos)
00_InsumosGenerales.R
Creación y definición del raster base (extensión, resolución y sistema de referencia espacial).
01_Insumosxhuella_automatizado.R
Procesamiento de los datos que describen las presiones antrópicas.
02_IHEH_calculo.R
Asignación de pesos e integración de las presiones para el cálculo del IHEH.
03_DatosGeonetwork.R
Preparación de los datos en formato compatible con GeoNetwork.
🔹 pipelines

Rutinas utilizadas en 01_Insumosxhuella_automatizado.R:

vias_ferreas.R
Descarga_y_mergePop.R
osm_cat_vector.R
Navegabilidad.R
creación_LU0_y_TNT_corine.R
creación_LU0_y_TNT_mp.R

Rutinas utilizadas en 02_IHEH_calculo.R:
...
00_InsumosGenerales.R
Preparación de insumos base para el cálculo del IHEH.
Estos insumos definen parámetros generales como proyección y extensión.

Además, se generan:

Capas constantes (ej. ecosistemas potenciales y tiempo de intervención)
Tabla de consulta para la clasificación de biomasa y uso del suelo
01_Insumosxhuella.R
Generación de insumos necesarios para el cálculo del IHEH, almacenados en la carpeta de resultados intermedios (Res_Intermedios).
02_HuellaHumana_Diaz.R
Cálculo de la huella (año 2018) replicando el modelo original en ArcMap de Julián Díaz.
Se incluyen algunos ajustes por razones computacionales.
03_HuellaHumana_adaptada.R
Cálculo de la huella basado en el método de ecosistemas, incluyendo:
Uso de variables continuas como continuas
Remoción de variables no esenciales

04_HuellaHumana_adaptadaVias.R
Variante del cálculo que incluye diferenciación de vías:
...
⚠️ Nota: Los pesos no son idénticos a los utilizados en Huella_IAVH2025_Corine.

🔹 Miscelaneo (descripción parcial)
prueba_categorías.R
Permite analizar la distribución de los valores de los factores de la huella en categorías discretas.
📁 Huella_IAVH2025_Mapbiomas
00_InsumosGenerales.R
Preparación de insumos base (proyección, extensión y capas constantes).
01_Insumosxhuella.R
Generación de insumos y almacenamiento en Res_Intermedios.
02_Pesos_navegabilidad.R
Cálculo de presiones asociadas a la navegabilidad de ríos.
021_Pesos_ferreos.R
Cálculo de presiones asociadas a vías férreas.
03_HuellaHumana_adaptadaVias.R
Cálculo de la huella con:
Variables continuas
Remoción de variables no esenciales
Diferenciación de vías (mismas categorías descritas anteriormente)
📁 Huella_IAVH2025_Corine
00_InsumosGenerales.R
Preparación de insumos base y capas constantes.
01_Insumosxhuella.R
Generación de insumos, incluyendo:
Clasificación de tipos de vías (vector)
Descarga y procesamiento de población (mosaico y densidad)
Creación de raster de coberturas
Generación de capas transformadas y no transformadas
021_Pesos_ferreos.R
Cálculo de presiones asociadas a vías férreas.
03_HuellaHumana_adaptadaVias.R
Cálculo de la huella con:
